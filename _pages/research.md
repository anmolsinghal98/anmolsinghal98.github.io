...
# Requirements Elicitation and Human-AI Collaboration

Since joining CMU, my work has centered on building LLM-powered systems that support requirements elicitation and facilitate shared understanding among diverse stakeholders during early-stage software design. Requirements interviews are difficult: interviewers must formulate good questions in real time while managing unfamiliar domains, high cognitive load, and information overload. To support them, I investigated how LLMs can generate follow-up interview questions grounded in a framework of common interviewer mistakes. In controlled experiments, the [LLM-generated questions](https://arxiv.org/abs/2507.02858) were rated no worse than human-authored ones on clarity, relevance, and informativeness—and outperformed them when generation was guided by mistake types. This work appeared at RE 2025.

I am also studying how humans and AI agents divide roles when collaborating on open-ended design tasks. In a Wizard-of-Oz pilot study, I examined the emergent role differentiation that arises when a personality-aware LLM assistant participates in real-time requirements brainstorming during software design discussions. This work will appear at the Co-Data workshop at CHI 2026.

# Legal Requirements Translation

A recurring theme in my research is bridging the gap between legal or regulatory language and technical implementation. I developed a neuro-symbolic approach that translates legal text into a canonical representation encodable and executable as Python code, using textual entailment and in-context learning over a domain-specific metamodel. Evaluated on 13 U.S. state data breach notification laws, our generated representations passed roughly 89.4% of test cases while outperforming JSON parsing baselines. This [work](https://arxiv.org/abs/2507.02846) received the Best Artifact Award at RE 2025.
